...
$count = (int) LittleDino_Theme_Helper::get_option('shop_r_products_per_page');        
...
if ( $related_products ) : ?>
	...
	<?php
			$heading = apply_filters( 'woocommerce_product_related_products_heading', esc_html__( 'Related products', 'littledino' ) );
