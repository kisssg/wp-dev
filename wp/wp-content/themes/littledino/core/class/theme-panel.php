    ...
    class Wgl_Theme_Panel{
        ...
        */
        ...
        public function theme_panel_admin_menu(){
            add_menu_page (
                esc_html__('WebGeniusLab', 'littledino'),
                esc_html__('WebGeniusLab', 'littledino'), 
            ...
            $submenu = array();
            $submenu[] = array(
                esc_html__('Welcome', 'littledino'),    //page_title
                esc_html__('Welcome', 'littledino'),    //menu_title
                'manage_options',                               //capability
            ...
            if (current_user_can( 'activate_plugins' )):
                $submenu[] = array(
                    esc_html__('Theme Plugins', 'littledino'),   //page_title
                    esc_html__('Theme Plugins', 'littledino'),   //menu_title
            ...
            $submenu[] = array(
                esc_html__('Requirements', 'littledino'),   //page_title
                esc_html__('Requirements', 'littledino'),   //menu_title
                'edit_posts',                          //capability
            ...
            $submenu[] = array(
                esc_html__('Activate Theme', 'littledino'),   //page_title
                esc_html__('Activate Theme', 'littledino'),   //menu_title
                'edit_posts',                           //capability
            ...
            $submenu[] = array(
                esc_html__('Help Center', 'littledino'),   //page_title
                esc_html__('Help Center', 'littledino'),   //menu_title
                'edit_posts',                           //capability
            ...
            if ( class_exists( 'LittleDino_Core' ) ) {
                $submenu[] = array(
                    esc_html__('Theme Options', 'littledino'),   //page_title
                    esc_html__('Theme Options', 'littledino'),   //menu_title
                    'edit_posts',                           //capability
