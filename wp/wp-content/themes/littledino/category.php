<?php
/**
 * Template for Category archive page
 *
 * @package littledino
...
$sb = LittleDino_Theme_Helper::render_sidebars('blog_list');
    ...
    <div id='main-content' class="wgl_col-<?php echo apply_filters('littledino_column_class', $column); ?>">
        ...
        if (!empty($term_id)) {
            echo '<div class="blog_archive-cat">';
                echo '<h4 class="blog_archive-cat_title">', esc_html__('Category:', 'littledino'), ' ', esc_html($cat_title), '</h4>';
